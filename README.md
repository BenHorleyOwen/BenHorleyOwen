...
### photodiode laser microphone (1):
- this is for the challenge of making it

### LED compass, integrated to calendar and google maps (7):
- this is for the challenge of making it

### Network access point house device room map (9, 11):
- devices typically connect to the strongest access point so a house with one in each room could have a map built based off network connection logs
...
### basic honeypot (18):
- nginx, ngrok, cowry docker container as a fake exposed ssh container
...
- this is for a self challenge

### seemless car playlist predictor based off of measured traffic conditions (27):
- 

### screen watching password guesser(13):
- password guesser absed off of password input speed, trained off of watching the individals average wpm, and how specific words take different amounts of time to type
...
- making this purely out of spite

### polyglot file writer (33):
- polyglot files are files which have the structure be to able to change type when changing the extension without needing a converter
- when changing between pngs and txt for example it has the ability to hold content for both
- a app would need to be able to create the basic structure and have a panel to be able to mdify the contents of each type without constantly editing the extension

### Tsevhu language pond generator (37):
...
OCR library shelf assistant (10)

automated journal backup (36)

## previous projects:

Extended Autospy to highlight hex bytes based off of file patterns: university dissertataion project, no number assigned.
collection of coding challenges: leetcode practice.
